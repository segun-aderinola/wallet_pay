  ...
  <div class='col-sm-10'>
    ...
    <?php
     ...
     $cnic=$_SESSION['login_user'];
      ...
      $sql = "SELECT people.* FROM people INNER JOIN individual ON people.serial_no=individual.individual_id AND people.emp_id='$emp_id' order by people.serial_no LIMIT ".$page1.",5";
$result = mysqli_query($conn, $sql);
