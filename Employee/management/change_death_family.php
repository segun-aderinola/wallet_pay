...
<div class="container_fluid ">
  <h5 style='color:green;text-align:center;'>Enter the date of death of the family member</h5>
<?php
...
if($res=mysqli_query($conn,$sql)){
  ...
  if(isset($_POST['submit'])){
  	...
  	if($death_date>$dat){
  		...
  		$quey="SELECT people.*,family.head_id FROM people INNER JOIN family ON   serial_no='$death_id' AND people.serial_no=family.family_id";
          ...
          $gender=$row['gender'];
          $head_id=$row['head_id'];
  				$sql="INSERT INTO death(id,name,father_name,birthday,age_of_death,emp_id,head_id,gender) VALUES('$id','$name','$fatherName','$age','$death_date','$emp_id','$head_id','$gender')";
