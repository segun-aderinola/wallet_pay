...
<div class="container_fluid ">
  <h5 style='color:green;text-align:center;'>Enter the date of death of the individual member</h5>
<?php
  		...
  		if($result=mysqli_query($conn,$quey)){
  			...
  			{ 
  			  ...
  			  $fatherName=$row['fatherName'];
  				...
  				$age=$row['age'];
          $gender=$row['gender'];
  				$sql1="INSERT INTO death(id,name,father_name,birthday,age_of_death,emp_id,head_id,gender) VALUES('$id','$name','$fatherName','$age','$death_date','$emp_id','$id','$gender')";
