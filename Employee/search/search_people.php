...
<div class="container_fluid" style="margin-left:120px;">
  <h5 style='color:green;text-align:center;'>Click View Family To View Family of head</h5>
       ...
       <form class="navbar-form navbar-left" method='post' action="search_people.php">
    ...
    <?php
     ...
     $cnic=$_SESSION['login_user'];
      ...
      $sql = "SELECT people.*
FROM people
INNER JOIN head_family ON people.serial_no=head_family.head_id AND people.emp_id='$emp_id' AND (people.name LIKE '%$search%' OR people.fatherName LIKE '%$search%' OR people.cnic like '$search' ) order by people.serial_no";
$result = mysqli_query($conn, $sql);
...
?></td>
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class='btn btn-danger' href="management/Delete_head.php?delete=<?php echo $id;?>">Delete</a></li>
