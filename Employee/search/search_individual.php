  ...
  <div class="container-fluid row">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class='active'><a href="../individual/individual_view.php">View Individual</a></li>
  ...
  <h5 style='color:green;text-align:center;'>Click View Family To View Family of head</h5>
    ...
    <?php
     ...
     $cnic=$_SESSION['login_user'];
      ...
      $sql = "SELECT people.*
FROM people
INNER JOIN individual ON people.serial_no=individual.individual_id AND people.emp_id='$emp_id' AND (people.name LIKE '%$search%' OR people.fatherName LIKE '%$search%' OR people.cnic like '$search' ) order by people.serial_no";
$result = mysqli_query($conn, $sql);
...
?></td>
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class='btn btn-danger' href="../management/Delete_individual.php?delete=<?php echo $id;?>">Delete</a></li>
